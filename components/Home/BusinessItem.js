...
function BusinessItem({ business, showDir = false }) {
    ...
    const onDirectionClick = () => {
        window.open('https://www.google.com/maps/dir/?api=1&origin=' +
            ...
            business.geometry.coordinates[1] + ',' + business.geometry.coordinates[0] + '&travelmode=driving');
    };
    ...
    return (
        <div className='w-[195px] flex-shrink-0 p-2 rounded-lg shadow-md mb-1 bg-white hover:scale-110 transition-all mt-[20px] cursor-pointer'>
            ...
            <h2 className='text-[10px] text-gray-400 line-clamp-2'>{business.place_name}</h2>
            ...
            {showDir ? <div className='border-t-[1px] p-1 mt-1'>
                <h2 className='text-[#0075ff] flex justify-between items-center'>Dist: {distance} Mile
